...
<div class="breadcrumbs" data-aos="fade-in">
      ...
      <form name="info" method="POST" action="order.php">  
            ...
            <table class="table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="cname" id="car"><input type="hidden" name="model_no" id="model_no"></td>  
  ...
  <?php
         ...
         $mod=trim($_POST['model_no']);
         $pr=trim($_POST['price']);
         $od=trim($_POST['order_date']);
         $cn=trim($_POST['cust_name']);
         $ad=trim($_POST['address']);
         $mn=trim($_POST['mobile_no']);
         $pc=trim($_POST['pincode']);
         $em=trim($_POST['email']);
         $oi=trim($_POST['order_id']);
         $qty=trim($_POST['qty']);
         $tot=trim($_POST['total']);

          $sql="INSERT INTO `orders`( `cname` ,`model_no`, `price`, `order_date`, `cust_name`, `address`, `mobile_no`, `pincode`, `email`, `order_id`, `qty`, `total`) VALUES ('$cname','$mod','$pr','$od','$cn','$ad','$mn','$pc','$em','$oi','$qty','$tot')";
         //echo $sql;

          $result=mysqli_query($con,$sql);
          if ($result)
           {
              echo "<div class='alert alert-success'>Data submited successfully</div>";
           }
          else{
            echo "<div class='alert alert-warning'>Data Is Not Found</div>";
          }
         }
         ?>    
    </div>          
